...
class MainWindow(CTk):
    def __init__(self):
        ...
        self.username = "oleksandr"

        # Меню
        self.label = None
        self.menu_frame = CTkFrame(self, width=30, height=300, fg_color='#011A27')
        self.menu_frame.pack_propagate(False)
        self.menu_frame.place(x=0, y=0)
        self.is_show_menu = False
        self.speed_animate_menu = -2
        self.btn = CTkButton(self, text="▶️", command=self.toggle_show_menu, width=30)
        self.btn.place(x=0, y=0)

        # Основное поле чату
        self.chat_field = CTkScrollableFrame(self, fg_color='#063852')
        ...
        self.send_button.place(x=0, y=260)
        ...
        self.add_message("Демонстрація відображення зображення:", CTkImage(Image.open('chat.png'), size=(300, 300)))
    ...
    def add_message(self, message, img=None):
        ...
        message_frame.pack(padx=5, anchor='w')
